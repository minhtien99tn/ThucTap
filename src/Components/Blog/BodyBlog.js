              ...
              <div className="col-lg-8 entries">
                <article className="entry">
                  <div className="entry-img">
                    <img src="assets/img/blog-post-1.jpg" alt="" className="img-fluid" />
                  </div>
                  ...
                  <div className="entry-meta">
                    <ul>
                      <li className="d-flex align-items-center"><i className="icofont-user" /> <a href="blog-single.html">John
                          Doe</a></li>
                      ...
                      <li className="d-flex align-items-center"><i className="icofont-comment" /> <a href="blog-single.html">12
                          Comments</a></li>
                    </ul>
                  </div>
                ...
                <article className="entry">
                  <div className="entry-img">
                    <img src="assets/img/blog-post-2.jpg" alt="" className="img-fluid" />
                  </div>
                  <h2 className="entry-title">
                ...
                <article className="entry">
                  <div className="entry-img">
                    <img src="assets/img/blog-post-3.jpg" alt="" className="img-fluid" />
                  </div>
                  <h2 className="entry-title">
                ...
                <article className="entry">
                  <div className="entry-img">
                    <img src="assets/img/blog-post-4.jpg" alt="" className="img-fluid" />
                  </div>
                  <h2 className="entry-title">
